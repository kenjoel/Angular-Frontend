...
export class AppComponent {
  quotes: quotes[] = [
    ...
    new quotes("“A successful man is one who can lay a firm foundation with the bricks others have thrown at him.”", "David Brinkly","KenJoel Muigai", new Date(2020,7,21))
  ]
